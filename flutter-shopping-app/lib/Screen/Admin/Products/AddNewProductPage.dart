        ...
        appBar: AppBar(
          ...
          actions: [
            TextButton(
                ...
                child:
                    TextFrave(text: ' Save ', color: ColorsFrave.primaryColor))
          ],
        ),
        body: Form(
          key: _keyForm,
          child: ListView(
            ...
            children: [
              ...
              SizedBox(height: 10.0),
              TextFrave(text: 'Brand'),
              SizedBox(height: 5.0),
              FormFieldFrave(
                controller: _brandController,
                hintText: 'Brand',
                keyboardType: TextInputType.text,
                validator: RequiredValidator(errorText: 'Brand is required'),
              ),
              SizedBox(height: 10.0),
              TextFrave(text: 'Quantity'),
              SizedBox(height: 5.0),
              FormFieldFrave(
                controller: _quantityController,
                hintText: 'Brand',
                keyboardType: TextInputType.number,
                validator: RequiredValidator(errorText: 'Quantity is required'),
              ),
              SizedBox(height: 20.0),
